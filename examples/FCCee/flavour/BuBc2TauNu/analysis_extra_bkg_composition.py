    ...
    def analysers(df):
        df2 = (
            df
               ...
               ######################################################
               .Define("MC_p_thrust_angle",    "Algorithms::getAxisCosTheta(EVT_thrust, MC_px, MC_py, MC_pz)")
               .Define("MC_vert_thrust_angle", "Algorithms::getAxisCosTheta(EVT_thrust, MC_fromvert_x, MC_fromvert_y, MC_fromvert_z)")
