...
outputDirEos   = "/eos/experiment/fcc/ee/analyses_storage/flavor/hadron_tagging/flatNtuples/winter2023/only_for_Bc"
    ...
    def analysers(df):
        df2 = (
            df
               ...
               .Filter("label_hasBc_Emin==1 || label_hasBc_Emax==1")
